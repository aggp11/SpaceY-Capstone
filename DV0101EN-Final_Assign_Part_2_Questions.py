...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(
            ...
            y='Automobile_Sales',
            hue = 'Vehicle_Type',
            title = "Effect of Unemployment Rate on Vehicle Type and Automobile Sales during Recession"))
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(
            ...
            x='Year',
            y='Automobile_Sales',
            title='Average Yearly Automobile Sales by Vehicle Type'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(
            ...
            x='Month',
            y='Automobile_Sales',
            title='Total Montly Autombile Sales'))

# Plot bar chart for average number of vehicles sold during the given year
        avr_vdata=yearly_data.groupby(['Year','Vehicle_Type'])['Automobile_Sales'].mean().reset_index()
        avr_vdata.set_index('Year', inplace = TRUE)
        Y_chart3 = dcc.Graph(
            figure=px.bar(avr_vdata.filter(like=input_year, axis = 0),
            x='Vehicle_Type',
            y='Automobile_Sales',
...
# Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(
            ...
            values='Advertising_Expenditure',
            names='Vehicle_Type',
            title="Advertisment Expenditure per Vehicle Type"))
